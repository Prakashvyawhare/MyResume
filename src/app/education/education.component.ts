...
export class EducationComponent implements OnInit {
  ...
  Be = new Education("B.E.","Parvatibai Genba moze College Of Engineering","8.41 CGPA",2022,"Mechanical Engineering");
  constructor() { 
    let Be= new Education("B.E.","Genba Sopanroa Moze Trust's Parvatibai Genba Moze College of Engineering, Pune","8.41 CGPA",2022,"Mechanical Engineering");
